...
The look & feel of the post2peer widget is very close to its cousin, the [YD Recent Posts Widget](http://wordpress.org/extend/plugins/yd-recent-posts-widget/).

Please visit the [YD Post2Peer Widget plugin support site](http://www.yann.com/wp-plugins/post2peer-wordpress-plugin "Yann Dubois' Post2Peer Widget for Wordpress")
 and the [Post2Peer.com open posts directory](http://post2peer.com/about "Post2Peer posts and sites directory") to get more info on the Post2Peer project and what's it's all about.
...
Drop me a line on my [YD Post2Peer Widget plugin support site](http://www.yann.com/wp-plugins/post2peer-wordpress-plugin "Yann Dubois' Post2Peer Widget for Wordpress") to report bugs, ask for specific feature or improvement, or just tell me how you're using the plugin.
It's still in an early development stage, with new features coming out on a regular basis.

== Installation ==

1. Unzip yd-p2p-widget.zip
1. Upload the `yd-p2p-widget` directory and all its contents into your `/wp-content/plugins/` directory
...
http://www.yann.com/wp-plugins/post2peer-wordpress-plugin
